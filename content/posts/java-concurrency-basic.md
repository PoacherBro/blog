...
![Java内存模型抽象示意图](http://cdn2.infoqstatic.com/statics_s1_20161115-0325/resource/articles/java-memory-model-1/zh/resources/11.png)
...
![](http://cdn2.infoqstatic.com/statics_s1_20161115-0325/resource/articles/java-memory-model-1/zh/resources/22.png)
...
```
    如果执行时机不对，那么两个线程在调用`getNext`时会得到相同的值。
